cd /home/wjy/spec2017/benchspec/CPU/544.nab_r/run/run_base_refrate_mytest-m64.0000
...
for i in $(seq 0 $((num_threads - 1))); do
    ...
    if [ -n "$core_str" ]; then
        cmd="taskset -c $core_str ./nab_r_base.mytest-m64 1am0 1122214447 122"
    else
        cmd="./nab_r_base.mytest-m64 1am0 1122214447 122"
    fi

    eval "$cmd" > nab_${i}.out  2>> nab_${i}.err  &
done
